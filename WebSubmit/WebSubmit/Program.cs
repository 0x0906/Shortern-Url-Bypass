...
namespace WebSubmit
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(Script(input.Replace("https://link.tnshort.net/", string.Empty)).Result);
            Console.ReadLine();
        }
        ...
        static async Task<string> Script(string code)
        {
            ...
            requestHeaders.Add("Referer", "https://jrlinks.in/"); //PATCH 06-FEB-2024
            ...
            else
            {
                ...
                else
                {
                    ...
                    requestHeaders.Add("Cache-Control", "no-cache");
                    requestHeaders.Add("Referer", "https://go.tnshort.net/" + arg1);
                    requestHeaders.Add("Accept-Encoding", "gzip, deflate");
                    #endregion
